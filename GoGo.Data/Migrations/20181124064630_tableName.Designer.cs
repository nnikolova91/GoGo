...
namespace GoGo.Data.Migrations
{
    ...
    [Migration("20181124064630_tableName")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoGo.Models.Photos.Photo", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GoGo.Models.Photos.DestinationPhoto", b =>
                {
                    b.HasBaseType("GoGo.Models.Photos.Photo");
                    ...
                    b.HasDiscriminator().HasValue("DestinationPhoto");
                });

            modelBuilder.Entity("GoGo.Models.Photos.GoUserPhoto", b =>
                {
                    b.HasBaseType("GoGo.Models.Photos.Photo");
                    ...
                    b.Property<string>("UserId")
                        .HasColumnName("GoUserPhoto_UserId");

                    b.HasIndex("UserId")
                        .IsUnique()
                        .HasFilter("[GoUserPhoto_UserId] IS NOT NULL");

                    b.ToTable("GoUserPhoto");

                    b.HasDiscriminator().HasValue("GoUserPhoto");
                });
            ...
            modelBuilder.Entity("GoGo.Models.Photos.GoUserPhoto", b =>
                {
                    b.HasOne("GoGo.Models.GoUser", "User")
                        .WithOne("Photo")
                        .HasForeignKey("GoGo.Models.Photos.GoUserPhoto", "UserId");
                });
